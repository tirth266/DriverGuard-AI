  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <GlassCard className="p-12 md:p-[90px] rounded-[36px] text-center relative overflow-hidden border border-border shadow-2xl transition-shadow hover:shadow-primary/10">
            {/* Subtle Glow orbs */}
            <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
              <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/10 blur-[100px] rounded-full animate-pulse" />
              <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-primary/10 blur-[80px] rounded-full animate-pulse" />
            </div>
